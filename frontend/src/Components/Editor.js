...
getcode(data.uniquename).then((data)=>{
setQ(data.Q)
  if(lang=="javascript")
  {
    if (data && data.Q && data.Q.jsmain) {
...
if (data && data.Q && data.Q.description) {
  ...
  <div>
    ...
    <div className="d-flex justify-content-between flex-md-row flex-column">
      ...
      <div
        ...
        tabIndex={0}
      >
        {Q&&(Q.solution && <Solution mode={mode} value={Q?Q.solution:""} />)}
      </div>
      <div
        ...
        <div className="overflow-auto">
           {params&&(params.uniquename && <Submitions  question={params.uniquename}/>)}
        </div>
        </div>
      </div>
      </div>
